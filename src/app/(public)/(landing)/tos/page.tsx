    ...
    <div>
      ...
      <div className="mt-12 space-y-8">
        <div>
          <p>1. Terms</p>
          <p>
            By accessing this Website, accessible from https://www.{companyName}
            .jeanrobertou.com.fr, you are agreeing to be bound by these Website
            Terms and Conditions of Use and agree that you are responsible for
            the agreement with any applicable local laws. If you disagree with
        ...
        <div>
          ...
          <p>
            ...
            materials on https://www.{companyName}.jeanrobertou.com's Website
          ...
          <ul className="list-disc">
            ...
            <li className="ml-8">
              attempt to reverse engineer any software contained on https://www.
              {companyName}.jeanrobertou.com's Website;
            </li>
            <li className="ml-8">
          ...
          <p>
            This will let https://www.{companyName}.jeanrobertou.com to
        ...
        <div>
          <p>3. Disclaimer</p>
          <p>
            All the materials on https://www.{companyName}.jeanrobertou.com's
            Website are provided "as is". https://www.{companyName}
            .jeanrobertou.com makes no warranties, may it be expressed or
            implied, therefore negates all other warranties. Furthermore,
            https://www.{companyName}.jeanrobertou.com does not make any
        ...
        <div>
          <p>4. Limitations</p>
          <p>
            https://www.{companyName}.jeanrobertou.com or its suppliers will not
            be hold accountable for any damages that will arise with the use or
            inability to use the materials on https://www.{companyName}
            .jeanrobertou.com's Website, even if https://www.{companyName}
            .jeanrobertou.com or an authorize representative of this Website has
        ...
        <div>
          ...
          <p>
            The materials appearing on https://www.{companyName}
            .jeanrobertou.com's Website may include technical, typographical, or
            photographic errors. https://www.{companyName}.jeanrobertou.com will
            not promise that any of the materials in this Website are accurate,
            complete, or current. https://www.{companyName}.jeanrobertou.com may
            change the materials contained on its Website at any time without
            notice. https://www.{companyName}.jeanrobertou.com does not make any
        ...
        <div>
          <p>6. Links</p>
          <p>
            https://www.{companyName}.jeanrobertou.com has not reviewed all of
            ...
            imply endorsement by https://www.{companyName}.jeanrobertou.com of
        ...
        <div>
          ...
          <p>
            https://www.{companyName}.jeanrobertou.com may revise these Terms of
